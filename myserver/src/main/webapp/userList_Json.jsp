...
<script type="text/javascript" >
	...
	function userUpdate() {
		...
		$('#btnUpdate').on('click',function(){
			...
			// 위 내용을 ajax에서 data: $('#form1').serialize()로 보낼 수 있다. Type은 String
			$.ajax({ 
			    url: conPath + '/users', 
			    type: 'PUT',
			    contentType: 'application/json; charset=UTF-8', // 요청 파라미터 타입
			    dataType: 'json',  // 응답 결과의 타입
			    data: JSON.stringify({id, name, password, role}) // put은 json string만 가능
			}).done( function(data) { 
			        userList();
